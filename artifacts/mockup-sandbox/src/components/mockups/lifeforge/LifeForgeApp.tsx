...
type ScreenId =
  ...
  | 'habitCreate' | 'lifestyle' | 'aiLoading' | 'aiPlan' | 'auth'
...
const ONBOARDING_FLOW: ScreenId[] = [
  'splash', 'onboarding', 'goalSelect', 'problem', 'habitCreate', 'lifestyle', 'aiLoading', 'aiPlan', 'auth',
];
...
const SCREEN_MAP: Record<ScreenId, React.ComponentType> = {
  ...
  problem: Problem, habitCreate: HabitCreate, lifestyle: Lifestyle, aiLoading: AiLoading, aiPlan: AiPlan, auth: Auth,
